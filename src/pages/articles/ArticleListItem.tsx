    ...
    <>
      {articles.map((article: any) => (
        ...
        <div
          ...
          className="flex flex-row bg-white rounded-md shadow-sm"
        >
          <div style={{ flex: 1 }}>
            ...
            <div className="flex flex-row justify-between items-center px-4 py-3">
              ...
              <p className="text-sm font-medium text-gray-600">Read More...</p>
            </div>
          </div>
      ...
      {selectedArticleId && (
        <ArticleDetail
          ...
          closeArticleModal={resetSelectedArticleId}
        />
      )}
    </>
  );
